        ...
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <nav className="font-body flex flex-wrap items-center justify-center gap-5 text-sm font-medium text-white/50 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex min-h-11 items-center gap-1.5 px-1 transition-colors hover:text-[#00e87b]"
            >
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/register"
              className="flex min-h-11 items-center px-1 transition-colors hover:text-[#00e87b]"
            >
              Register
            </Link>
            <a
